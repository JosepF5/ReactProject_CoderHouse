...
const NavBar = () => {
  ...
  /* return (
    <nav className="container-nav bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <a href="https://flowbite.com/" className="flex items-center">
          <img
            ...
            alt="FQ5 Logo"
          />
          <span className="self-center text-xl branding font-semibold whitespace-nowrap dark:text-white">
            FQ5 STORE
          </span>
        </a>
        <button
